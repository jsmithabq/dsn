...
public class TimeCriticalTargeting {
  private static final String DEFAULT_TITLE = "Time Critical Targeting";
  ...
  private NewTrackingAction newTrackingAction =
    new NewTrackingAction("New Tracking");
  private StartTrackingAction startTrackingAction =
    new StartTrackingAction("Start Tracking");
  private StopTrackingAction stopTrackingAction =
    new StopTrackingAction("Stop Tracking");
...
//    frame.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
    ...
    stopTrackingAction.setEnabled(false);
  ...
  private JMenuBar buildMainWindowMenu() {
    ...
    file.add(exitAction);
    menubar.add(file);
    JMenu simulation = new JMenu("Tracking");
    simulation.add(newTrackingAction);
    simulation.add(stopTrackingAction);
...
//            currentTargetBehaviorClassname + ".");
  ...
  private JToolBar buildTargetTrackingWindowToolbar() {
    JToolBar toolbar = new JToolBar();
    toolbar.add(startTrackingAction);
    toolbar.add(stopTrackingAction);
    return toolbar;
  }

  private JPopupMenu buildTargetTrackingWindowPopup() {
    JPopupMenu popup = new JPopupMenu();
    popup.add(startTrackingAction);
    popup.add(stopTrackingAction);
    return popup;
  }

  private void enableActions() {
    newTrackingAction.setEnabled(true);
    startTrackingAction.setEnabled(true);
    stopTrackingAction.setEnabled(true);
    targetBehaviorCB.setEnabled(true);
  }

  private void disableActions() {
    newTrackingAction.setEnabled(false);
    startTrackingAction.setEnabled(false);
    stopTrackingAction.setEnabled(false);
  ...
  private void newTargetTracking() {
    ...
    simulationWindow = new JFrame("TargetTracking");
...
//    c.setLayout(null);
    JToolBar toolbar = buildTargetTrackingWindowToolbar();
    c.add(toolbar, BorderLayout.NORTH);
    visualArea = new VisualArea(gridColor);
    JPopupMenu popup = buildTargetTrackingWindowPopup();
...
//    SwingUtilities.invokeLater(new TargetHandler(sensorSim));
  ...
  private void closeTargetTracking() {
  ...
  private class NewTrackingAction extends AbstractAction {
    private NewTrackingAction(String text) {
      super(text);
    }
  ...
  private class StartTrackingAction extends AbstractAction {
    private StartTrackingAction(String text) {
      super(text);
    }
    public void actionPerformed(ActionEvent e) {
      startTargetTracking();
  ...
  private class StopTrackingAction extends AbstractAction {
    private StopTrackingAction(String text) {
      super(text);
    }
    public void actionPerformed(ActionEvent e) {
      stopTargetTracking();
